...
.\nuget.exe pack ..\src\DbLocalizationProvider.JsResourceHandler\DbLocalizationProvider.JsResourceHandler.csproj -Properties Configuration=Release #-IncludeReferencedProjects
